...
<div id='menu'>
    <ul id='ulTextItems'>
		...
		<li><a href="javascript:submenuArrowClick('Design')" border="0">Design <img id="DesignSubmenuArrow" class='submenuArrow' src="images/<?php print(!$SubmenuVisible['Design'] ? "arrowRight.png" : "arrowDown.png"); ?>" width="11" height="11" /></a>
			<div id="DesignSubmenu" class='submenu' <?php if (!$SubmenuVisible['Design']) {print("style='display: none'");} ?>>
				<ul id="ulDesignSubmenu">
					<li><a href="Design.php">Introduction</a></li>
		...
		<li><a href="javascript:submenuArrowClick('Articles')" border="0">Supporting Articles <img id="ArticlesSubmenuArrow" class='submenuArrow' src="images/<?php print(!$SubmenuVisible['Articles'] ? "arrowRight.png" : "arrowDown.png"); ?>" width="11" height="11" /></a>
			<div id="ArticlesSubmenu" class='submenu' <?php if (!$SubmenuVisible['Articles']) {print("style='display: none'");} ?>>
				<ul id="ulArticlesSubmenu">
