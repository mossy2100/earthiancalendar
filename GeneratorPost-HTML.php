	...
	foreach ($page as $week)
	{
		for ($dayOfWeek = 1; $dayOfWeek <= 7; $dayOfWeek++)
		{
			...
			if ($isOtherMonth)
			{
				...
				println("<div class='dayNum otherMonth' >".(EarthianDate::$abbrevMonthNames[$earthDate->month].' '.$earthDate->day)."</div>");
				println("<div class='note otherMonth'>$note</div>");
				println("<div class='greg otherMonth'>".dtlFormat($gregDate, "Day D Mon YYYY")."</div>");
			}
			else
			{
