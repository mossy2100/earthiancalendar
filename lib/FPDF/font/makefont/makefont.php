...
function ReadAFM($file, &$map) {
  ...
  $fm = [];
  $fix =
    ['Edot'                 => 'Edotaccent', 'edot' => 'edotaccent', 'Idot' => 'Idotaccent',
     ...
     'Tcedilla'             => 'Tcommaaccent', 'tcedilla' => 'tcommaaccent', 'Dslash' => 'Dcroat',
     'dslash'               => 'dcroat', 'Dmacron' => 'Dcroat', 'dmacron' => 'dcroat',
     'combininggraveaccent' => 'gravecomb', 'combininghookabove' => 'hookabovecomb',
     'combiningtildeaccent' => 'tildecomb',
     'combiningacuteaccent' => 'acutecomb', 'combiningdotbelow' => 'dotbelowcomb',
     'dongsign'             => 'dong'];
  foreach ($a as $l) {
    $e = explode(' ', rtrim($l));
    if (count($e) < 2) {
