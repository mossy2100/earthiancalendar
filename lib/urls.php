 ...
 * If this is a local file, appends a querystring parameter 'mtime' with the modified time of the
 * file. This will cause the browser to reload the file if it gets changed.
 *
 * @param string $url
 *
 * @return string
