...
printbr($cPattern2);
printbr($cPattern3);
printbr($cPattern1 == $cPattern2 ? 'Cycle pattern 1 == Cycle pattern 2' :
  'Cycle pattern 1 != Cycle pattern 2');
printbr($cPattern1 == $cPattern3 ? 'Cycle pattern 1 == Cycle pattern 3' :
  'Cycle pattern 1 != Cycle pattern 3');
printbr($cPattern2 == $cPattern3 ? 'Cycle pattern 2 == Cycle pattern 3' :
  'Cycle pattern 2 != Cycle pattern 3');

//printbr($mPattern1);
//printbr($mPattern3);
printbr($mPattern1 == $mPattern3 ? 'Month pattern 1 == Month pattern 3' :
  'Month pattern 1 != Month pattern 3');
