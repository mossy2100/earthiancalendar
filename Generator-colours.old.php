<tr>
  ...
  <td>
    <input type="radio" name="colorMode" id="colorMode5" value='5'
      onclick='updatePreview()' <?php if (!isset($form['colorMode']) || $form['colorMode'] == '5') {
      echo 'checked';
    } ?> /><label for='colorMode5'> Rainbow colours.</label><br/> <input type="radio"
      name="colorMode" id="colorMode4" value='4'
      onclick='updatePreview()' <?php if ($form['colorMode'] == '4') {
      echo 'checked';
    } ?> /><label for='colorMode4'> Traditional Thai colours.</label><br/> <input type="radio"
      name="colorMode" id="colorMode3" value='3'
      onclick='updatePreview()' <?php if ($form['colorMode'] == '3') {
      echo 'checked';
    } ?> /><label for='colorMode3'> Colour 1 for weekends, colour 2 for other days.</label><br/>
    <input type="radio" name="colorMode" id="colorMode1" value='1'
      onclick='updatePreview()' <?php if ($form['colorMode'] == '1') {
      echo 'checked';
    } ?> /><label for='colorMode1'> Interpolate colours: colour 1 for weekend, colour 2 for middle
      of week.</label><br/> <input type="radio" name="colorMode" id="colorMode2" value='2'
      onclick='updatePreview()' <?php if ($form['colorMode'] == '2') {
      echo 'checked';
    } ?> /><label for='colorMode2'> Interpolate colours: colour 1 for beginning of the week, colour
      2 for end of week.</label><br/>
  </td>
</tr>
<?php
for ($j = 1; $j <= 2; $j++) {
