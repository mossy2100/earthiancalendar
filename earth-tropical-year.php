 ...
 *
 * This currently uses UTC but it may need to be modified to use TT. However, the small offset
 * (number of seconds) is probably unlikely to affect the result (at least, not very much).
 */
